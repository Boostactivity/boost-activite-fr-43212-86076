...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="Marketing digital moderne" className="w-full h-full object-cover opacity-10" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subtitle */}
          <p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-fade-in-up [animation-delay:200ms]">Boost Activity est une agence de marketing digital qui allie stratégie, design et innovation pour accélérer votre croissance.</p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up [animation-delay:400ms]">
            <Button size="lg" className="gradient-primary text-white shadow-medium hover:shadow-strong transition-smooth group min-w-[200px]" onClick={() => scrollToSection("services")}>
              Découvrir nos services
              <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-smooth" />
            </Button>
            <Button size="lg" variant="outline" className="border-primary text-primary hover:bg-primary hover:text-white transition-smooth min-w-[200px]" onClick={() => scrollToSection("contact")}>
              Nous contacter
            </Button>
          </div>
